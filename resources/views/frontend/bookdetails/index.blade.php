          ...
          <div class="product product--layout--standard" data-layout="standard">
             <div class="product__content">
                ...
                <div class="product__gallery">
                   <div class="product-gallery">
                      <div class="product-gallery__featured">
                         <div class="owl-carousel" id="product-image"><a href="{{asset('library/images/products/product-16.html')}}" target="_blank"><img src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="{{asset('library/images/products/product-16-1.html')}}" target="_blank"><img src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="{{asset('library/images/products/product-16-2.html')}}" target="_blank"><img src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="{{asset('library/images/products/product-16-3.html')}}" target="_blank"><img src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="{{asset('library/images/products/product-16-4.html')}}" target="_blank"><img src="{{url(Storage::url($book->image))}}" alt=""></a></div>
                      </div>
                      <div class="product-gallery__carousel">
                         <div class="owl-carousel" id="product-carousel"><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{url(Storage::url($book->image))}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{url(Storage::url($book->image))}}" alt=""></a></div>
                      </div>
                   </div>
                </div>
                ...
                <div class="product__info">
                   ...
                   <h1 class="product__name">{{$book->name}}</h1>
                   ...
                   <div class="product__description">{{$book->description}}</div>
                   ...
                   <ul class="product__meta">
                      <li class="product__meta-availability">Availability: <span class="text-{{$book->quantity > 0 ? 'success' : 'danger'}}">{{$book->quantity > 0 ? 'In Stock' : 'Out of stock'}}</span></li>
                ...
                <div class="product__sidebar">
                   <div class="product__availability">Availability: <span class="text-{{$book->quantity > 0 ? 'success' : 'danger'}}">{{$book->quantity > 0 ? 'In Stock' : 'Out of stock'}}</span></div>
                         ...
                         <div class="reviews-list">
                            <ol class="reviews-list__content">
                               <li class="reviews-list__item">
                                  <div class="review">
                                     <div class="review__avatar"><img src="{{asset('library/images/avatars/avatar-1.jpg')}}" alt=""></div>
                               ...
                               <li class="reviews-list__item">
                                  <div class="review">
                                     <div class="review__avatar"><img src="{{asset('library/images/avatars/avatar-2.jpg')}}" alt=""></div>
                                     <div class="review__content">
                               ...
                               <li class="reviews-list__item">
                                  <div class="review">
                                     <div class="review__avatar"><img src="{{asset('library/images/avatars/avatar-3.jpg')}}" alt=""></div>
                                     <div class="review__content">
             ...
             <div class="block-header__arrows-list">
                <button class="block-header__arrow block-header__arrow--left" type="button">
                   <svg width="7px" height="11px">
                      <use xlink:href="{{asset('library/images/sprite.svg#arrow-rounded-left-7x11')}}"></use>
                   </svg>
                </button>
                <button class="block-header__arrow block-header__arrow--right" type="button">
                   <svg width="7px" height="11px">
                      <use xlink:href="{{asset('library/images/sprite.svg#arrow-rounded-right-7x11')}}"></use>
                   </svg>
                </button>
             </div>
          </div>
