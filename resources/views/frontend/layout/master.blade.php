...
<html lang="en" dir="ltr">
   <head>
      ...
      <link rel="icon" type="image/png" href="{{asset('library/images/favicon.png')}}">
      <!-- fonts -->
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i">
      <!-- css -->
      <link rel="stylesheet" href="{{asset('library/vendor/bootstrap-4.2.1/css/bootstrap.min.css')}}">
      <link rel="stylesheet" href="{{asset('library/vendor/owl-carousel-2.3.4/assets/owl.carousel.min.css')}}">
      <link rel="stylesheet" href="{{asset('library/css/style.css')}}">
      <!-- font - fontawesome -->
      <link rel="stylesheet" href="{{asset('library/vendor/fontawesome-5.6.1/css/all.min.css')}}">
      <!-- font - stroyka -->
      <link rel="stylesheet" href="{{asset('library/fonts/stroyka/stroyka.css')}}">
      @yield('style')
   </head>
   <body>
      <!-- quickview-modal -->
         ...
         <div class="mobilemenu__body">
            <div class="mobilemenu__header">
               ...
               <button type="button" class="mobilemenu__close">
                  <svg width="20px" height="20px">
                     <use xlink:href="{{asset('library/images/sprite.svg#cross-20')}}"></use>
                  </svg>
               </button>
            </div>
            <div class="mobilemenu__content">
               <ul class="mobile-links mobile-links--level--0" data-collapse data-collapse-opened-class="mobile-links__item--open">
                     ...
                     <div class="mobile-links__item-title">
                        ...
                        <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                           <svg class="mobile-links__item-arrow" width="12px" height="7px">
                              <use xlink:href="{{asset('library/images/sprite.svg#arrow-rounded-down-12x7')}}"></use>
                           </svg>
                        </button>
                     </div>
                  ...
                  <li class="mobile-links__item" data-collapse-item>
                     <div class="mobile-links__item-title">
                        <a href="{{route('books.index')}}" class="mobile-links__item-link">Shop</a> 
                        <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                           <svg class="mobile-links__item-arrow" width="12px" height="7px">
                              <use xlink:href="{{asset('library/images/sprite.svg#arrow-rounded-down-12x7')}}"></use>
                           </svg>
                     ...
                     <div class="mobile-links__item-sub-links" data-collapse-content>
                        <ul class="mobile-links mobile-links--level--1">
                           <li class="mobile-links__item" data-collapse-item>
                              <div class="mobile-links__item-title">
                                 <a href="{{route('books.index')}}" class="mobile-links__item-link">Shop Grid</a> 
                                 <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                    <svg class="mobile-links__item-arrow" width="12px" height="7px">
                                       <use xlink:href="{{asset('library/images/sprite.svg#arrow-rounded-down-12x7')}}"></use>
                                    </svg>
                              ...
                              <div class="mobile-links__item-sub-links" data-collapse-content>
                                 <ul class="mobile-links mobile-links--level--2">
                                    <li class="mobile-links__item" data-collapse-item>
                                       <div class="mobile-links__item-title"><a href="{{route('books.index')}}" class="mobile-links__item-link">3 Columns Sidebar</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                     ...
                     <div class="mobile-header__body">
                        <button class="mobile-header__menu-button">
                           <svg width="18px" height="14px">
                              <use xlink:href="{{asset('library/images/sprite.svg#menu-18x14')}}"></use>
                           </svg>
                        </button>
                        ...
                        <div class="mobile-header__search">
                           <form class="mobile-header__search-form" action="#">
                              ...
                              <button class="mobile-header__search-button mobile-header__search-button--submit" type="submit">
                                 <svg width="20px" height="20px">
                                    <use xlink:href="{{asset('library/images/sprite.svg#search-20')}}"></use>
                                 </svg>
                              </button>
                        ...
                        <div class="mobile-header__indicators">
                           ...
                           <div class="indicator indicator--mobile d-sm-flex d-none">
                              <a href="{{route('wishlist.index')}}" class="indicator__button">
                                 <span class="indicator__area">
                                    <svg width="20px" height="20px">
                                       <use xlink:href="{{asset('library/images/sprite.svg#heart-20')}}"></use>
                                    </svg>
                                    <span class="indicator__value">@if (Auth::guard('customer')->check()) {{$wishlistCount}} @else 0 @endif</span>
                                 </span>
                              </a>
                           </div>
                           <div class="indicator indicator--mobile">
                              <a href="cart.html" class="indicator__button">
                                 <span class="indicator__area">
                                    <svg width="20px" height="20px">
                                       <use xlink:href="{{asset('library/images/sprite.svg#cart-20')}}"></use>
                                    </svg>
                                    <span class="indicator__value">@if (Auth::guard('customer')->check()) {{$cartCount}} @else 0 @endif</span>
                                 </span>
                              </a>
                           </div>
                        </div>
               ...
               <div class="site-header__topbar topbar">
                  <div class="topbar__container container">
                     <div class="topbar__row">
                        ...
                        <div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{route('profile.index')}}">My Account</a></div>
                        ...
                        <div class="nav-panel__row">
                                    ...
                                    <div class="departments__links-wrapper">
                                       <ul class="departments__links">
                                          ...
                                          <li class="departments__item">
                                             <a href="{{route('books.index', $category->id)}}">{{$category->name}}</a>
                                          </li>
                                          @endforeach
                                       </ul>
                                    </div>
                           ...
                           <div class="nav-panel__nav-links nav-links">
                              <ul class="nav-links__list">
                                 <li class="nav-links__item"><a href="{{route('home')}}"><span>Home</span></a></li>
                                 <li class="nav-links__item"><a href="{{route('books.index')}}"><span>Books</span></a></li>
                                 <li class="nav-links__item"><a href="#"><span>About Us</span></a></li>
                                    ...
                                    <div class="dropcart">
                                          ...
                                          @if (Auth::guard('customer')->check())
                                             ...
                                             <div class="dropcart__product">
                                                <div class="dropcart__product-image">
                                                   <a href="{{route('bookdetails.index', $item->book_id)}}">
                                                      <img src="{{url(Storage::url($item->book->image))}}" alt="">
                                                   </a>
                                                </div>
                                                <div class="dropcart__product-info">
                                                   <div class="dropcart__product-name">
                                                      <a href="{{route('bookdetails.index', $item->book_id)}}">{{$item->book->name}}</a>
                                                   </div>
                                                   <div class="dropcart__product-meta">
                                                      <span class="dropcart__product-quantity">{{$item->quantity}}</span> x <span class="dropcart__product-price">${{$item->book->price}}</span>
                                                   </div>
                                                </div>
                                                <a href="{{route('cart.destroy', $item->id)}}" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon">
                                                   <svg width="10px" height="10px">
                                                      <use xlink:href="{{asset('library/images/sprite.svg#cross-10')}}"></use>
                                                   </svg>
                                                </a>
                                             </div>
                                             @endforeach
                                       ...
                                       <div class="dropcart__totals">
                                          <table>
                                             <tr>
                                                <th>Total</th>
                                                <td>$@if (Auth::guard('customer')->check()) {{$total}} @else 0 @endif</td>
                                             </tr>
                                          </table>
                                       </div>
                                       <div class="dropcart__buttons">
                                          <a class="btn btn-secondary" href="{{route('cart.index')}}">View Cart</a>
      ...
      <!-- js -->
      <script src="{{asset('library/vendor/jquery-3.3.1/jquery.min.js')}}"></script>
      <script src="{{asset('library/vendor/bootstrap-4.2.1/js/bootstrap.bundle.min.js')}}"></script>
      <script src="{{asset('library/vendor/owl-carousel-2.3.4/owl.carousel.min.js')}}"></script>
      <script src="{{asset('library/vendor/nouislider-12.1.0/nouislider.min.js')}}"></script>
      <script src="{{asset('library/js/number.js')}}"></script>
      <script src="{{asset('library/js/main.js')}}"></script>
      <script src="{{asset('library/vendor/svg4everybody-2.1.9/svg4everybody.min.js')}}"></script>
      <script>
        svg4everybody();
      </script>
