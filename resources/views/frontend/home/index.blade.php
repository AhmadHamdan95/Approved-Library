                ...
                <div class="block-slideshow__body">
                   <div class="owl-carousel">
                      ...
                      <a class="block-slideshow__slide" href="{{$slider->url}}">
                        <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url('{{url(Storage::url($slider->image))}}'); background-position: center; background-size: cover"></div>
                        {{-- <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile" style="background-image: url('{{asset('library/images/slides/slide-1-mobile.jpg')}}')"></div> --}}
